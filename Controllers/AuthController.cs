...
namespace Headway_Rhythm_Project_API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        {
            if (!await _authrepo.GoogleUserExists(googleUserToLogin.Email))
            {
                var user = await _authrepo.RegisterGoogleUser(googleUserToLogin);
            }

            var userFromRepo = await _authrepo.LoginGoogleUser(googleUserToLogin.Email);
